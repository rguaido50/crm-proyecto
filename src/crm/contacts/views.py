...
async def contact_detail_page(
    ...
    pending_tasks = await tasks_service.list_pending_for_contact(session, contact_id)
    activity = await tasks_service.list_activity_for_contact(session, contact_id)
